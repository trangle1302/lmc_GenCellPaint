...
class LatentDiffusion(DDPM):
    ...
    def gen_images(self, batch, N=8, n_row=4, sample=True, ddim_steps=200, ddim_eta=1., return_keys=None, unconditional_guidance_scale=1.0,
        ...
        if sample:
            ...
            # [1,0,0] = [-0.1061,  0.0417, -0.0044,  0.0092,  0.3162,  0.0459,  0.0933, -0.1837,
            #             0.0123, -0.3650, -0.4584, -0.1468, -0.1006,  0.1227, -0.0220,  0.1476,
            #             0.0778,  0.0768, -0.2280,  0.0535,  0.0184, -0.2902, -0.2048,  0.1330,
            #            -0.3181, -0.1064,  0.0559,  0.2908, -0.0787,  0.1615,  0.3464,  0.1923],
            # [0,1,0] = [ 0.0085, -0.0499,  0.2723, -0.0662,  0.2588,  0.2847,  0.2959, -0.2192,
            #             0.1303, -0.3716, -0.3998, -0.1020,  0.0485,  0.0220,  0.1869,  0.1523,
            #             0.0413,  0.3577,  0.2823,  0.4296,  0.6879,  0.1451,  0.0076,  0.3192,
            #             -0.3657, -0.0918,  0.3067,  0.2286,  0.0247,  0.1717,  0.3659, -0.1247]
            # [0,0,1] = [-0.1928,  0.0637,  0.2759,  0.0406,  0.0215,  0.2127,  0.3264, -0.2192,
            # -0.3121, -0.2047, -0.5341,  0.0641,  0.0429, -0.1358,  0.3828,  0.3829,
            # 0.0345,  0.1840,  0.2436,  0.2195,  0.3873,  0.3780, -0.3923,  0.2546,
            # -0.3788, -0.0665,  0.0145,  0.1590,  0.2035, -0.1986,  0.3081, -0.0273]
